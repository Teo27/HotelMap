...
public class ObjectLoad{
    ...
    public void setup(){
        ...
        ObjectOfInterest obj5 = new ObjectOfInterest("Medicinski Kompleks", "Varna", ObjectOfInterest.Type.HOTEL,"Medical Complex",48, 5, 12345678, "Proximity Test", "Long description,Long description,Long description,Long description,Long description,Long description,Long description,Long description","http://hotelmap.bg",43.220032618316786,27.92651653289795,"2016-12-1 12:00:00",24);
